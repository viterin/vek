// Code generated by command: go run gen.go -out ../internal/accel_avx2_amd64.s -stubs ../internal/avx2_amd64.go -pkg internal. DO NOT EDIT.
...
// Requires: AVX
TEXT ·Gather_AVX2_F64(SB), NOSPLIT, $0-72
	MOVQ  x_base+0(FP), DI
	MOVQ  y_base+24(FP), SI
	MOVQ  z_base+48(FP), DX
	MOVQ  z_len+56(FP), CX
...
LBB4_4:
	...
	VMOVSD  (SI)(AX*8), X0
	MOVQ    8(DX)(R9*8), AX
	VMOVHPS (SI)(AX*8), X0, X0
	MOVQ    16(DX)(R9*8), AX
	VMOVSD  (SI)(AX*8), X1
	MOVQ    24(DX)(R9*8), AX
	VMOVHPS (SI)(AX*8), X1, X1
	MOVQ    32(DX)(R9*8), AX
	VMOVSD  (SI)(AX*8), X2
	MOVQ    40(DX)(R9*8), AX
	VMOVHPS (SI)(AX*8), X2, X2
	MOVQ    48(DX)(R9*8), AX
	VMOVSD  (SI)(AX*8), X3
	MOVQ    56(DX)(R9*8), AX
	VMOVHPS (SI)(AX*8), X3, X3
	MOVQ    64(DX)(R9*8), AX
	VMOVSD  (SI)(AX*8), X4
	MOVQ    72(DX)(R9*8), AX
	VMOVHPS (SI)(AX*8), X4, X4
	MOVQ    80(DX)(R9*8), AX
	VMOVSD  (SI)(AX*8), X5
	MOVQ    88(DX)(R9*8), AX
	VMOVHPS (SI)(AX*8), X5, X5
	MOVQ    96(DX)(R9*8), AX
	VMOVSD  (SI)(AX*8), X6
	MOVQ    104(DX)(R9*8), AX
	VMOVHPS (SI)(AX*8), X6, X6
	MOVQ    112(DX)(R9*8), AX
	VMOVSD  (SI)(AX*8), X7
	MOVQ    120(DX)(R9*8), AX
	VMOVHPS (SI)(AX*8), X7, X7
	VMOVUPS X1, 16(DI)(R9*8)
	VMOVUPS X0, (DI)(R9*8)
	VMOVUPS X3, 48(DI)(R9*8)
	VMOVUPS X2, 32(DI)(R9*8)
	VMOVUPS X5, 80(DI)(R9*8)
	VMOVUPS X4, 64(DI)(R9*8)
	VMOVUPS X7, 112(DI)(R9*8)
	VMOVUPS X6, 96(DI)(R9*8)
	ADDQ    $0x10, R9
	CMPQ    R8, R9
	JNE     LBB4_4
	CMPQ    R8, CX
...
// Requires: AVX
TEXT ·Gather_AVX2_F32(SB), NOSPLIT, $0-72
	MOVQ  x_base+0(FP), DI
	MOVQ  y_base+24(FP), SI
	MOVQ  z_base+48(FP), DX
	MOVQ  z_len+56(FP), CX
...
LBB5_4:
	...
	VMOVSS    (SI)(AX*4), X0
	MOVQ      8(DX)(R9*8), AX
	VINSERTPS $0x10, (SI)(AX*4), X0, X0
	MOVQ      16(DX)(R9*8), AX
	VINSERTPS $0x20, (SI)(AX*4), X0, X0
	MOVQ      24(DX)(R9*8), AX
	VINSERTPS $0x30, (SI)(AX*4), X0, X0
	MOVQ      32(DX)(R9*8), AX
	VMOVSS    (SI)(AX*4), X1
	MOVQ      40(DX)(R9*8), AX
	VINSERTPS $0x10, (SI)(AX*4), X1, X1
	MOVQ      48(DX)(R9*8), AX
	VINSERTPS $0x20, (SI)(AX*4), X1, X1
	MOVQ      56(DX)(R9*8), AX
	VINSERTPS $0x30, (SI)(AX*4), X1, X1
	MOVQ      64(DX)(R9*8), AX
	VMOVSS    (SI)(AX*4), X2
	MOVQ      72(DX)(R9*8), AX
	VINSERTPS $0x10, (SI)(AX*4), X2, X2
	MOVQ      80(DX)(R9*8), AX
	VINSERTPS $0x20, (SI)(AX*4), X2, X2
	MOVQ      88(DX)(R9*8), AX
	VINSERTPS $0x30, (SI)(AX*4), X2, X2
	MOVQ      96(DX)(R9*8), AX
	VMOVSS    (SI)(AX*4), X3
	MOVQ      104(DX)(R9*8), AX
	VINSERTPS $0x10, (SI)(AX*4), X3, X3
	MOVQ      112(DX)(R9*8), AX
	VINSERTPS $0x20, (SI)(AX*4), X3, X3
	MOVQ      120(DX)(R9*8), AX
	VINSERTPS $0x30, (SI)(AX*4), X3, X3
	VMOVUPS   X0, (DI)(R9*4)
	VMOVUPS   X1, 16(DI)(R9*4)
	VMOVUPS   X2, 32(DI)(R9*4)
	VMOVUPS   X3, 48(DI)(R9*4)
	ADDQ      $0x10, R9
	CMPQ      R8, R9
	JNE       LBB5_4
	CMPQ      R8, CX
...
// Requires: AVX
TEXT ·Scatter_AVX2_F64(SB), NOSPLIT, $0-72
	MOVQ  x_base+0(FP), DI
	MOVQ  y_base+24(FP), SI
	MOVQ  z_base+48(FP), DX
	MOVQ  z_len+56(FP), CX
...
LBB6_4:
	...
	MOVQ   8(DX)(R9*8), AX
	VMOVSD X0, (DI)(AX*8)
	VMOVSD 16(SI)(R9*8), X0
	MOVQ   16(DX)(R9*8), AX
	VMOVSD X0, (DI)(AX*8)
	VMOVSD 24(SI)(R9*8), X0
	MOVQ   24(DX)(R9*8), AX
	VMOVSD X0, (DI)(AX*8)
	ADDQ   $0x04, R9
	CMPQ   CX, R9
...
// Requires: AVX
TEXT ·Scatter_AVX2_F32(SB), NOSPLIT, $0-72
	MOVQ  x_base+0(FP), DI
	MOVQ  y_base+24(FP), SI
	MOVQ  z_base+48(FP), DX
	MOVQ  z_len+56(FP), CX
